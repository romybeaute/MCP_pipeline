...
default_path = '/home/dragana.manasova/Documents/data/eeg_doc_usa/NKT/eeg_new' 
# default_predict_path = ('/home/dragana.manasova/Documents/data/eeg_doc_usa/NKT/eeg_new/results'
...
parser.add_argument('--subject', metavar='subject', nargs=1, type=str,
                    # default = 'DA58708X_1-1+-permed-rs-nihonkohden.edf',
                    default='AA0103N6-permed-rs-nihonkohden.EEG',
...
if True:
    ...
    data = nice_ext.api.read(
                            '/home/dragana.manasova/Documents/data/eeg_doc_usa/NKT/eeg_new/' , 
                            'permed/rs/eeg/nihonkohden')
    print('Channels : ', data.ch_names)

    # Preprocess & Report
    epochs, summary = nice_ext.api.preprocess(data, config='permed/rs/raw/nk',
                                                  config_params={'summary': True, #'reject': 100e-6,
                                                                  'hpass': 0.5, 'lpass': 45.})#, 
                                                                  # 'min_channels': 0.4})
                                                                  
    epochs.save('/home/dragana.manasova/Documents/data/eeg_doc_usa/NKT/eeg_new/AA0103N6_epochs01_w_reject_auto_wo-T7T8P7P8FT9FT10.fif')
    
    report01 = nice_ext.api.create_report(epochs, title='Preprocessing', config='icm/preprocess',
                                        config_params={'summary': summary})
    report_sname = '/home/dragana.manasova/Documents/data/eeg_doc_usa/NKT/eeg_new/AA0103N6_report01_w_reject_auto_wo-T7T8P7P8FT9FT10.html'
...
#%%
# nihonfile = '/home/dragana.manasova/Documents/data/eeg_doc_usa/NKT/eeg_new/AA0103N6-permed-rs-nihonkohden.EEG' 
# raw = mne.io.read_raw_nihon(nihonfile, preload=True, verbose=True)


epochs.plot_psd(fmax=50, average=True)
epochs[0:10].plot()
data.plot(butterfly=True)


epochs = mne.read_epochs('/home/dragana.manasova/Documents/data/eeg_doc_usa/NKT/eeg_new/epochs01_w_reject_100_wo-T7T8P7P8FT9FT10.fif')


#%%

raw = mne.io.read_raw_edf('/home/dragana.manasova/Documents/data/eeg_doc_usa/NKT/eeg_new/DA58708X_1-1+.edf')


raw = mne.io.read_raw_nihon('/home/dragana.manasova/Documents/data/eeg_doc_usa/NKT/eeg_new/AA0103N6-permed-rs-nihonkohden.EEG') 
