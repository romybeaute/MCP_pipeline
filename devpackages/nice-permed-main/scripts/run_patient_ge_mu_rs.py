...
f_names = ["TestMuc_cogEEG_26jul2021_rs_healthyPhD"
    ]

s_i = 0  # which pax to be read from f_names

default_path = '/home/dragana.manasova/Documents/data/permed/germany/subjects/munich/rs/'
default_predict_path = ('/home/dragana.manasova/Documents/data/permed/germany/results'
...
try:
    ...
    if report is not None:
        out_fname = 'permed_germany_mu_rs_{}_{}_{}_full_report.html'.format(subject.split('_')[4], subject.split('_')[0], now)
